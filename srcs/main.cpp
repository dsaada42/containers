...
//SIMPLE DELETION TEST
    {
        ...
        tree.printTree();
        tree.erase(ft::make_pair(11, "")); // node is red no children (leaf) 
        tree.printTree();
        //**** OK *****
    }
    {
        ...
        tree.printTree();
        tree.erase(ft::make_pair(8, "")); // node is black, no left child (no right child also, so right child is null_node and will replace node)
        tree.printTree();
        //**** OK *****
    }
    {
        ...
        tree.insert(ft::make_pair(6, "test6"));
        tree.printTree();
        tree.erase(ft::make_pair(5, "")); // node is black, no left child but right child
        tree.printTree();
        //**** OK *****
    }
    {
        ...
        tree.printTree();
        tree.erase(ft::make_pair(4, "")); // node is black, has left child
        tree.printTree();
        //**** OK *****
    }
//COMPLEX DELETION TESTS
    {
        ...
        // tree.insert(ft::make_pair(11, "test11"));
        // tree.printTree();
        // tree.erase(15);//delete with 2 valid children and 1 left child on max subleft
        //**** OK ****

        tree.erase(ft::make_pair(15, "")); // delete with 2 valid children and no child on max subleft
        tree.printTree();
    }   //**** OK ****
    {
        std::cout << "********************************************" << std::endl;
        ...
        tree.printTree();
        tree.erase(ft::make_pair(8, "")); // delete node with 2 valid children, left child is only child
        tree.printTree();
